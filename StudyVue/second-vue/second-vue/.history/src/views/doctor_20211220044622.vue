    ...
    <div id="admin-div">
        <el-col :span="12" id="el-col">
            <el-menu default-active="2" class="el-menu-vertical-demo"
                ...
                <el-menu-item index="4" @click="info('number')">
...
<script>
  ...
  import number from '../components/doctor/number.vue'
  import writeRecord from '../components/doctor/writeRecord.vue'

  export default {
  components: {displayDoctor, number,displayPatient, writeRecord },
    data: function(){
        return {
