    ...
    methods: {
        modify() {
            ...
            for(let i = 0; i < oldList.length; ++i) {
                if(Object.prototype.hasOwnProperty.call(mySelect, oldList[i])) {
            ...
            let myDepartments = JSON.stringify(function() {
                let obj= Object.create(null);
                for (let[k,v] of newSelect) {
                obj[k] = v;
                }
                return obj;
            });
            ...
            let param = qs.stringify({
                ...
                departments : JSON.stringify(newSelect)
            })
             console.log(JSON.stringify(newSelect));
