<template>
    <div id="modifyDoctorInfoDiv">
        ...
        <div class="item">
            <label>doctorCurrentAllNumber: </label>
            <el-input v-model="doctorCurrentAllNumber"></el-input>
        </div>
    ...
    methods: {
        ...
        modify() {
            ...
            let param = qs.stringify({
                ...
                doctorCurrentAllNumber : that.doctorCurrentAllNumber
            }); 

            this.$axios.post('http://localhost:8080/admin/insertDoctor', param)
