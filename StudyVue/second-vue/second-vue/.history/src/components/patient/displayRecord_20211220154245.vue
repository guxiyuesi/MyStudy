<template>
    <div id="patientInfoDiv">
        ...
        <div class="input" id="buttons">
            <el-button type="primary" @click="test">before</el-button>
            <el-button type="primary" @click="after">after</el-button>
        </div>
    </div>
</template>
  ...
  export default {
    ...
    methods:{
        ...
        console.log('hello world');
            that.index = (thiat.index + 1) % that.medicalRecord.length;
            let param1 = qs.stringify({
                medicalRecordId : that.medicalRecord[that.index].medicalRecordId
            })
