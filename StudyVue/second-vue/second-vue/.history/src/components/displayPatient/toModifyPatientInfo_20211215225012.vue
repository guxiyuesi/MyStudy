...
export default {
    ...
    mounted() {
        ...
        this.patientDefaultAllNumber = this.rowValue.patientDefaultAllNumber;
        this.patientPassword = this.rowValue.patientPassword;
        this.ispatient = this.rowValue.ispatient;
    }, 
    methods: {
        cancel() {
        ...
        modify() {
            ...
            let param = qs.stringify({
                ...
                patientDefaultAllNumber : that.patientDefaultAllNumber,
                patientPassword : that.patientPassword,
                ispatient : that.ispatient
            }); 
