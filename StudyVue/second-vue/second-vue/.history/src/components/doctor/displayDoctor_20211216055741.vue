...
export default {
    ...
    mounted() {
        ...
        .then(function(response) {
            ...
            this.theDoctorId = response.data.doctorId;
            this.doctorName = response.data.doctorName;
            this.doctorGender = response.data.doctorGender;
            this.doctorPhoneNumber = response.data.doctorPhoneNumber;
            this.doctorAge = response.data.doctorAge;
            this.departmentName = response.data.departmentName;
            this.doctorDefaultAllNumber = response.data.doctorDefaultAllNumber;
            this.doctorPassword = response.data.doctorPassword;
        });
