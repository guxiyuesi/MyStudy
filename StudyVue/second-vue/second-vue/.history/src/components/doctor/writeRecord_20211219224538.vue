            ...
            height="470">
                ...
                width="145">
                    <template slot-scope="scope">
                        <el-input v-model="scope.row.theDrugNum"></el-input>
                    </template>
                </el-table-column>
                ...
                width="70">
                <template slot-scope="scope">
                    <el-button @input="" @click.native.prevent="deleteRow(scope.$index, tableData)" type="text" size="small">取消</el-button>
                </template>
                </el-table-column>
            </el-table>
        </div>
...
export default {
    ...
    methods: {
        select(row) {
            ...
            theDrugs.theDrugNumber = row.drugNumber;
