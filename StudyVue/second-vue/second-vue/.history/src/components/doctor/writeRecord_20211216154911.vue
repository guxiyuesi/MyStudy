    ...
    <div id="modifyDoctorInfoDiv">
        ...
        <div class="query" id="drugTable">
            ...
            height="470">
                ...
                <template slot-scope="scope">
                    <el-button  @click="cancel(scope.row)" type="text" size="small">选择</el-button>
                </template>
            </el-table>
        </div>
    </div>
...
export default {
    ...
    mounted() {
        ...
        let param2 = qs.stringify({
            theDepartment: that.departmentId
        })
        

        this.$axios.post('http://localhost:8080/doctor/getDrugsByDepartmentId', param2)
            .then(function(response){
